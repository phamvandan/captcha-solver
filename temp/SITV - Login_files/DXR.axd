...
.dxlpLoadingPanelWithContent .dxlp-loadingImage {
	background: url('/DXR.axd?r=1_128-vWMVj');
	height: 16px;
	width: 16px;
}
.dxlpControl
...
{
	background-image: url('/DXR.axd?r=1_135-vWMVj');
}
...
.dxpLite .dxp-dropDownButton
{
    ...
    background: #e6e6e6 url('/DXR.axd?r=1_145-vWMVj') repeat-x top;
    
}
.dxpLite .dxp-hoverDropDownButton
{
    border: 1px solid #606060;
    background: #f2f2f2 url('/DXR.axd?r=1_146-vWMVj') repeat-x top;
}
...
{
	background: #E8E7E8 url('/DXR.axd?r=1_154-vWMVj') repeat-x;
	border: 1px solid #7F7F7F;
	padding: 5px;
}
...
{
	background: #F4F4F4 url('/DXR.axd?r=1_155-vWMVj') repeat-x;
}
...
.dxtcLite > .dxtc-stripContainer .dxtc-sbDisabled
{
	cursor: default;
	border-color: #C3C3C3;
	background: #E6E7E8 url('/DXR.axd?r=1_156-vWMVj') repeat-x;
}
...
.dxucBrowseButton
{
	padding: 4px 8px 3px;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_167-vWMVj') repeat-x top;
}
...
{
	border: 1px solid #606060;
	background: #F2F2F2 url('/DXR.axd?r=1_168-vWMVj') repeat-x top;
}
...
{
	background: url('/DXR.axd?r=1_149-vWMVj') repeat;
	font-size: 0;
	line-height: 0px;
}
...
.dxtvControl .dxtv-ln
{
	background: url('/DXR.axd?r=1_150-vWMVj') repeat-y;
	vertical-align: top;
}
...
.dxtvControl .dxtv-elb
{
	background: url('/DXR.axd?r=1_151-vWMVj') no-repeat;
}
...
.dxtvControl.dxtvRtl .dxtv-elb
{
	background-image: url('/DXR.axd?r=1_152-vWMVj');
}
...
{
	width: 3px;
	background: url('/DXR.axd?r=1_157-vWMVj') repeat-y right;
	border-width: 0px;
}
...
{
    background-image: url('/DXR.axd?r=1_131-vWMVj');
...
.dxigItem
{
    background-repeat: no-repeat;
    background-position:center center;
    background-image: url('/DXR.axd?r=1_132-vWMVj');
}
.dxigItem a
{
    outline: 0;
...
{
    width: 43px;
    background: url('/DXR.axd?r=1_133-vWMVj') repeat-y;
}
.dxigControl .dxig-bottomPanel .dxis-nbBottom > .dxis-prevBtnHorWrapper
{
...
.dxrControl .dxtcLite.dxtc-top .dxr-fileTab {
    background: #e5e5e5 url('/DXR.axd?r=1_170-vWMVj') repeat-x;
    border-color: #a8a8a8;
    border-left-width: 1px;
    border-right-width: 1px;
}
.dxrControl .dxtcLite.dxtc-top .dxtc-tabHover.dxr-fileTab {
    background: #E8E7E8 url('/DXR.axd?r=1_171-vWMVj') repeat-x;
    border-color: #a8a8a8;
}
...
/* Color edit */
.dxcpColorAreaSys {
	background-image: url('/DXR.axd?r=1_252-vWMVj');
	position: relative;
	width: 290px;
	height: 240px;
	overflow: hidden;
...
.dxcpHueAreaImageSys {
	background-image: url('/DXR.axd?r=1_254-vWMVj');
	position: absolute;
	left: 6px;
	width: 21px;
    height: 240px;
...
.dxcpColorPointerSys {
	background-image: url('/DXR.axd?r=1_253-vWMVj');
	position: absolute;
	width: 11px;
	height: 11px;
}
.dxcpHuePointerSys {
	background-image: url('/DXR.axd?r=1_255-vWMVj');
	position: absolute;
	width: 35px;
	height: 9px;
}
...
{
	background-image:  url('/DXR.axd?r=1_240-vWMVj');
}
.dxeTBVSys .dxeTBTrack
{
	background-image:  url('/DXR.axd?r=1_239-vWMVj');
}
...
{
	background-image:  url('/DXR.axd?r=1_238-vWMVj');
}
.dxeTBVSys .dxeTBBarHighlight
{
	background-image:  url('/DXR.axd?r=1_237-vWMVj');
}
...
.dxeTBHSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_229-vWMVj');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_234-vWMVj');
}
.dxeTBVSys .dxeTBItem 
{
	background-image:  url('/DXR.axd?r=1_232-vWMVj');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_233-vWMVj');
}
...
{
	background-image: url('/DXR.axd?r=1_230-vWMVj');
}
.dxeTBVSys .dxeTBSmallTick
{
	background-image: url('/DXR.axd?r=1_231-vWMVj');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBLargeTick
{
	background-image: url('/DXR.axd?r=1_235-vWMVj');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBLargeTick
{
	background-image: url('/DXR.axd?r=1_236-vWMVj');
}
...
.dxeSpinLargeDecButton
{
	background: #e6e6e6 url('/DXR.axd?r=1_249-vWMVj') repeat-x top;
}
.dxeSpinIncButton
{
	background: #F0F0F0 url('/DXR.axd?r=1_245-vWMVj') repeat-x top;
}
.dxeSpinDecButton
{
	background: #E6E6E6 url('/DXR.axd?r=1_246-vWMVj') repeat-x top;
}
.dxeCalendarButton,
.dxeColorEditButton
{
	background: #e5e5e5 url('/DXR.axd?r=1_247-vWMVj') repeat-x top;
...
{
	background: #F2F2F2 url('/DXR.axd?r=1_250-vWMVj') repeat-x top;
	border: 1px Solid #606060;
}
.dxeSpinIncButtonHover
{
...
{
	background: #F2F2F2 url('/DXR.axd?r=1_248-vWMVj') repeat-x top;
}
.dxeCalendarButtonHover,
.dxeColorEditButton:hover
{
...
.dxbButton
{
	...
	font: 12px Tahoma, Geneva, sans-serif;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_243-vWMVj') repeat-x top;
	padding: 1px;
}
.dxbButtonHover
{
	color: #000000;
	background: #F2F2F2 url('/DXR.axd?r=1_244-vWMVj') repeat-x top;
	border: 1px solid #606060;
}
.dxbButtonChecked
{
...
{
    background: url('/DXR.axd?r=1_124-vWMVj') no-repeat;
    float: left;
    height: 21px;
    vertical-align: top;
    width: 26px;
...
{
    background: url('/DXR.axd?r=1_125-vWMVj') no-repeat;
    float: right;
	margin-right: 0;
    margin-left: 0.3em;
...
.dxfcControl .dxfc-ln
{
    background: url('/DXR.axd?r=1_123-vWMVj') repeat-y;
    vertical-align: top;
}
...
{
	background-image: url('/DXR.axd?r=1_128-vWMVj');
	height: 16px;
	width: 16px;
}
.dxpcLite .dxHFBPS
...
.dxeToken {
	background: #ececec url('/DXR.axd?r=1_251-vWMVj') repeat-x top;
}
